...
class timing(Sofa.PythonScriptController):
    ...
    def initGraph(self,node):
        ...
        self.nodeLiver.getObject('LMC').findData("movements").value = "0 0 0 "

        #save a pointer to the ConstantForceField
        # self.RandomForce = self.nodeLiver.getObject('LMC')
        return 0
    ...
    def onBeginAnimationStep(self,dt):
        ...
        if self.time > 10.:
            ...
            self.nodeLiver.getObject('LMC').findData("movements").value = "20 0 0"
